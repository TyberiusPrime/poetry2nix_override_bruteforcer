    ...
    let
      buildSystem =
        ...
        then
          ...
          final.${attr};
    in
    if (attr == "flit-core" || attr == "flit" || attr == "hatchling") && !final.isPy3k then
      drv
    else if drv == null then
      null
    else if !drv ? overridePythonAttrs then
      drv
    else
...
[
  ...
  (
    ...
    lib.mapAttrs (
      attr: systems:
      builtins.foldl' (drv: attr: addBuildSystem' { inherit drv final attr; }) (prev.${attr} or null
      ) systems
    ) buildSystems
  )
  ...
  (final: prev: {
    ...
    "blake3" = prev."blake3".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "cdshealpix" = prev."cdshealpix".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "clvm-rs" = prev."clvm-rs".overridePythonAttrs (
      old: ((offlineMaturin lib.optionalAttrs (!(old.src.isWheel or false)) { }) old)
    );

    "clvm-tools-rs" = prev."clvm-tools-rs".overridePythonAttrs (old: ((standardMaturin { }) old));
    ...
    "gilknocker" = prev."gilknocker".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "h3ronpy" = prev."h3ronpy".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "imgsize" = prev."imgsize".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "kurbopy" = prev."kurbopy".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "lintrunner" = prev."lintrunner".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "lzallright" = prev."lzallright".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "mocpy" = prev."mocpy".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "netifaces2" = prev."netifaces2".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "nutils-poly" = prev."nutils-poly".overridePythonAttrs (old: ((standardMaturin { }) old));
    ...
    "pycddl" = prev."pycddl".overridePythonAttrs (old: (standardMaturin { }) old);

    "pycrdt" = prev."pycrdt".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "pyrevm" = prev."pyrevm".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "pytextspan" = prev."pytextspan".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "pywinpty" = prev."pywinpty".overridePythonAttrs (old: (standardMaturin { }) old);

    "pyxirr" = prev."pyxirr".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "regress" = prev."regress".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "rpds-py" = prev."rpds-py".overridePythonAttrs (old: ((standardMaturin { }) old));
    ...
    "solders" = prev."solders".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "tlparse" = prev."tlparse".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "topgrade" = prev."topgrade".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "tzfpy" = prev."tzfpy".overridePythonAttrs (old: (standardMaturin { }) old);
    ...
    "uuid-utils" = prev."uuid-utils".overridePythonAttrs (old: ((standardMaturin { }) old));
